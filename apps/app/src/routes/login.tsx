...
function LoginPage() {
  ...
  return (
    <div className="flex min-h-svh flex-col bg-[var(--meathill-cream)] text-[var(--meathill-brown-900)]">
      <BrandHeader
        currentSiteId="everband"
        locale="en"
        productName="Everband"
        productUrl="https://everband-app.meathill.com"
        actions={
          <a className="text-sm font-medium hover:underline" href={LANDING_URL}>
            Everband website
          </a>
        }
      />
      ...
      <BrandFooter
        currentSiteId="everband"
        description="Members, events and rehearsals for community bands."
        locale="en"
      />
    </div>
  );
