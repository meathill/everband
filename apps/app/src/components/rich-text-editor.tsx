...
export function RichTextEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          "prose prose-sm max-w-none min-h-40 w-full px-3 py-2 text-foreground outline-none prose-headings:font-semibold prose-headings:text-foreground prose-h2:text-xl prose-h3:text-lg prose-p:my-2 prose-strong:font-bold prose-strong:text-foreground prose-em:text-foreground prose-a:text-primary prose-a:underline prose-a:underline-offset-2 prose-blockquote:border-l-2 prose-blockquote:border-border prose-blockquote:pl-3 prose-blockquote:text-muted-foreground prose-ul:list-disc prose-ol:list-decimal prose-li:my-0.5 dark:prose-invert [&_h2]:!text-xl [&_h2]:!font-semibold [&_h2]:!text-foreground [&_h3]:!text-lg [&_h3]:!font-semibold [&_h3]:!text-foreground [&_strong]:!font-bold [&_a]:!text-primary [&_a]:!underline [&_blockquote]:!border-l-2 [&_ul]:!list-disc [&_ol]:!list-decimal placeholder:text-muted-foreground/72 [&_p.is-editor-empty]:before:content-[attr(data-placeholder)] [&_p.is-editor-empty]:before:pointer-events-none [&_p.is-editor-empty]:before:float-left [&_p.is-editor-empty]:before:h-0 [&_p.is-editor-empty]:before:text-muted-foreground/72",
