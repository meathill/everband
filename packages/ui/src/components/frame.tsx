...
export function FramePanel({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col rounded-xl border border-border bg-background bg-clip-padding p-5 shadow-xs/5 before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-xl)-1px)] before:shadow-[0_1px_--theme(--color-black/4%)] dark:before:shadow-[0_-1px_--theme(--color-white/6%)] *:[[data-slot=field]+[data-slot=field]]:mt-2",
        className,
      )}
